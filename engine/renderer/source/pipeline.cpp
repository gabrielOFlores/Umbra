...
namespace Umbra::Renderer
{
    ...
    {
        assert(config.pipelineLayout != VK_NULL_HANDLE && "Error: No pipelineLayout provided on config.");
        assert(config.renderPass != VK_NULL_HANDLE && "Error: No renderPass provided on config.");
        ...
        {
            throw std::runtime_error("Error: Failed to create the graphics pipeline, God help you...");
        }
    }
